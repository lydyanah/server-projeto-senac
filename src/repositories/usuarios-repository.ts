...
const usuariosRepository = {
	criar: (usuario: Usuario, callback: (idUsuario?: number) => void) => {
	...
	ler: (idUsuario: number, callback: (usuario?: Usuario) => void) => {
	...
	apagar: (idUsuario: number, callback: (notFound: boolean) => void) => {
